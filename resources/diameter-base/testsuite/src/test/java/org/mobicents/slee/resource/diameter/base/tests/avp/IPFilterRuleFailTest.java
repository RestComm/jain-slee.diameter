...
public class IPFilterRuleFailTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] { { "deny out udp from 192.168.0.0 to 192.168.1.1 established" }, { "permit in 9999 from 192.168.0.0/24 to 192.168.1.1 frag foo" },
				{ "permit in ip from 300.168.0.0/24 10,11,12,20-30 to 192.168.1.1 99 frag established" },
				{ "permit in ip from 257.168.0.0/24 10,11,12,20-30 to 192.168.1.1 99 frag established" }, { "deny out udp from 192.168.0.0 to 192.168.1.1 established" },
				...
				{ "permit out 2 from 2001:0db8:::1:8a2e:0370:7334 to fe80:0:0:0:202:b3ff:fe1e:8329 2345" }, { "permit out 2 from 2001:0db8:::7334 to fe80:0:0:0:202:b3ff:fe1e:8329 2345" },
