...
public class IPFilterRulePassTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] { { "permit in ip from 192.168.0.0/24 10,11,12,20-30 to 192.168.1.1 99 frag established" },
				...
				{ "deny in ip from !assigned to 192.1.1.1/0 6,3 frag established setup tcpoptions mrss" }, { "permit in 17 from 172.20.20.57 1031 to any" },
				{ "permit in 17 from any to 172.20.20.57 1031-2000,300 " }, { "permit in 17 from 172.20.20.57 1031-1300 to any 255,300-301" },
				{ "permit out 17 from any to 172.20.20.54 6557" }, { "permit in ip from 192.168.0.0/24 10,11,12,20-30 to 192.168.1.1 99 frag established" },
				{ "permit out 2 from 192.1.0.0/24 to 192.1.1.1/0 frag established setup tcpoptions mrss" }, { "permit out 2 from 192.1.0.0/24 to 192.1.1.1/0 2345" },
				{ "permit out 2 from !192.1.0.0/24 to 192.1.1.1/0 frag established setup tcpoptions mrss" },
				...
				{ "permit out 2 from 2001:0db8:85a3::7334 to fe80:0:0:0:202:b3ff:fe1e:8329 2345" }, { "permit out 2 from 2001:0db8::7334 to fe80:0:0:0:202:b3ff:fe1e:8329 2345" },
				{ "permit out 2 from 2001::7334 to fe80:0:0:0:202:b3ff:fe1e:8329 2345" }, { "permit out 2 from 2001:: to fe80:0:0:0:202:b3ff:fe1e:8329 2345" },
				{ "permit out 2 from :: to fe80:0:0:0:202:b3ff:fe1e:8329 2345" }, { "permit out 2 from any to 192.1.1.1/0 frag established setup tcpoptions mrss" },
				{ "permit out 2 from assigned 34 to 192.1.1.1/0 6,3 frag established setup tcpoptions mrss ipoptions !rr,!ts" },
