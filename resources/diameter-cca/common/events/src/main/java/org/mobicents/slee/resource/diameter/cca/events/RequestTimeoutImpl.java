 ...
 */
public class RequestTimeoutImpl implements RequestTimeout {
   ...
   * @param peer
   */
  public RequestTimeoutImpl(Message request, DiameterIdentity peer) {
  ...
  /*
   * (non-Javadoc)
   * @see net.java.slee.resource.diameter.cca.events.RequestTimeout#getRequest()
   */
  ...
  /*
   * (non-Javadoc)
   * @see net.java.slee.resource.diameter.cca.events.RequestTimeout#getLastPeer()
   */
  ...
  /*
   * (non-Javadoc)
   * @see net.java.slee.resource.diameter.cca.events.RequestTimeout#hasLastPeer()
   */
