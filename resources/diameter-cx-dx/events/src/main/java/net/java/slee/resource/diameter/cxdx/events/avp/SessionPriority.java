...
/**
 * 
 * AVP representation of Session-Priority AVP. Defined in 3GPP TS 29.229 version 12.7.0 Release 12
 * section 6.3.56.<br>
 * 
...
public class SessionPriority implements Serializable, Enumerated {
   ...
   */
  public static final SessionPriority PRIORITY_0 = new SessionPriority(_PRIORITY_0);

  public static final SessionPriority PRIORITY_1 = new SessionPriority(_PRIORITY_1);

  public static final SessionPriority PRIORITY_2 = new SessionPriority(_PRIORITY_2);

  public static final SessionPriority PRIORITY_3 = new SessionPriority(_PRIORITY_3);

  public static final SessionPriority PRIORITY_4 = new SessionPriority(_PRIORITY_4);
