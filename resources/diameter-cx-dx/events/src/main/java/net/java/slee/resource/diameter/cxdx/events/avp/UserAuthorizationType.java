 ...
 * in a User Authorization operation, i.e. UAR command. The following values are defined: ETSI
 *
 * 3GPP TS 29.229 version 12.7.0 Release 12 25 ETSI TS 129 229 V12.7.0 (2015-10)
 *
 * REGISTRATION (0)
 ...
 *     This value is used when the I-CSCF explicitly requests S-CSCF capability information from the HSS. The ICSCF
 *     shall use this value when the user's current S-CSCF, which is stored in the HSS, cannot be contacted
