...
import static org.mobicents.slee.resource.diameter.base.tests.factories.BaseFactoriesTest.MyConfiguration;
...
public class CxDxFactoriesTest {
	...
	static {
		...
		try {
			...
			org.jdiameter.server.impl.app.cxdx.CxDxServerSessionImpl stackServerSession = (org.jdiameter.server.impl.app.cxdx.CxDxServerSessionImpl) sf.getNewSession("123",
					ServerCxDxSession.class, cxdxAppId, new Object[0]);
			org.jdiameter.client.impl.app.cxdx.CxDxClientSessionImpl stackClientSession = (org.jdiameter.client.impl.app.cxdx.CxDxClientSessionImpl) sf.getNewSession("321",
					ClientCxDxSession.class, cxdxAppId, new Object[0]);
	...
	public void testGettersAndSettersMAR() throws Exception {
		...
		int nFailures = CxDxAvpAssistant.INSTANCE.testMethods(mar, MultimediaAuthenticationRequest.class);
	...
	public void isProxiableCopiedMAA() throws Exception {
		...
		MultimediaAuthenticationAnswer maa = serverSession.createMultimediaAuthenticationAnswer();
		assertEquals("The 'P' bit is not copied from request in Multimedia-Authentication-Answer, it should. [RFC3588/6.2]", mar.getHeader().isProxiable(), maa.getHeader()
				.isProxiable());
	...
	public void testGettersAndSettersRTR() throws Exception {
		...
		int nFailures = CxDxAvpAssistant.INSTANCE.testMethods(rtr, RegistrationTerminationRequest.class);
	...
	public void isProxiableCopiedRTA() throws Exception {
		...
		RegistrationTerminationAnswer rta = clientSession.createRegistrationTerminationAnswer();
		assertEquals("The 'P' bit is not copied from request in Registration-Termination-Answer, it should. [RFC3588/6.2]", rtr.getHeader().isProxiable(), rta.getHeader()
				.isProxiable());
	...
	public void testGettersAndSettersSAR() throws Exception {
		...
		int nFailures = CxDxAvpAssistant.INSTANCE.testMethods(sar, ServerAssignmentRequest.class);
	...
	public void testAvpFactoryCreateAssociatedRegisteredIdentities() throws Exception {
		...
		// And set all values using setters
		CxDxAvpAssistant.INSTANCE.testSetters(ariAvp2);

		// Create empty...
		AssociatedRegisteredIdentities ariAvp3 = cxdxAvpFactory.createAssociatedRegisteredIdentities();

		// Verify that no values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(ariAvp3, false);

		// Set all previous values
		ariAvp3.setExtensionAvps(ariAvp2.getExtensionAvps());

		// Verify if values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(ariAvp3, true);

		// Verify if values have been correctly set
		CxDxAvpAssistant.INSTANCE.testGetters(ariAvp3);
	...
	public void testAvpFactoryCreateChargingInformation() throws Exception {
		...
		// And set all values using setters
		CxDxAvpAssistant.INSTANCE.testSetters(ciAvp2);

		// Create empty...
		ChargingInformation ciAvp3 = cxdxAvpFactory.createChargingInformation();

		// Verify that no values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(ciAvp3, false);

		// Set all previous values
		ciAvp3.setExtensionAvps(ciAvp2.getExtensionAvps());

		// Verify if values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(ciAvp3, true);

		// Verify if values have been correctly set
		CxDxAvpAssistant.INSTANCE.testGetters(ciAvp3);
	...
	public void testAvpFactoryCreateDeregistrationReason() throws Exception {
		...
		// And set all values using setters
		CxDxAvpAssistant.INSTANCE.testSetters(drAvp2);

		// Create empty...
		DeregistrationReason drAvp3 = cxdxAvpFactory.createDeregistrationReason();

		// Verify that no values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(drAvp3, false);

		// Set all previous values
		drAvp3.setExtensionAvps(drAvp2.getExtensionAvps());

		// Verify if values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(drAvp3, true);

		// Verify if values have been correctly set
		CxDxAvpAssistant.INSTANCE.testGetters(drAvp3);
	...
	public void testAvpFactoryCreateRestorationInfo() throws Exception {
		...
		// And set all values using setters
		CxDxAvpAssistant.INSTANCE.testSetters(riAvp2);

		// Create empty...
		RestorationInfo riAvp3 = cxdxAvpFactory.createRestorationInfo();

		// Verify that no values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(riAvp3, false);

		// Set all previous values
		riAvp3.setExtensionAvps(riAvp2.getExtensionAvps());

		// Verify if values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(riAvp3, true);

		// Verify if values have been correctly set
		CxDxAvpAssistant.INSTANCE.testGetters(riAvp3);
	...
	public void testAvpFactoryCreateSCSCFRestorationInfo() throws Exception {
		...
		// Create AVP with mandatory values
		SCSCFRestorationInfo scscfriAvp1 = cxdxAvpFactory.createSCSCFRestorationInfo("SAMPLE.USERNAME",
				new RestorationInfo[] { cxdxAvpFactory.createRestorationInfo("SAMPLE.PATH".getBytes(), "SAMPLE.CONTACT".getBytes()) });
		...
		Assert.assertTrue("Created " + avpName + " AVP from default constructor should not have Restoration-Info AVP.",
				scscfriAvp2.getRestorationInfos() == null || scscfriAvp2.getRestorationInfos().length == 0);
		...
		// And set all values using setters
		CxDxAvpAssistant.INSTANCE.testSetters(scscfriAvp2);

		// Create empty...
		SCSCFRestorationInfo scscfriAvp3 = cxdxAvpFactory.createSCSCFRestorationInfo();

		// Verify that no values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(scscfriAvp3, false);

		// Set all previous values
		scscfriAvp3.setExtensionAvps(scscfriAvp2.getExtensionAvps());

		// Verify if values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(scscfriAvp3, true);

		// Verify if values have been correctly set
		CxDxAvpAssistant.INSTANCE.testGetters(scscfriAvp3);
	...
	public void testAvpFactoryCreateSIPAuthDataItem() throws Exception {
		...
		// And set all values using setters
		CxDxAvpAssistant.INSTANCE.testSetters(sadiAvp2);

		// Create empty...
		SIPAuthDataItem sadiAvp3 = cxdxAvpFactory.createSIPAuthDataItem();

		// Verify that no values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(sadiAvp3, false);

		// Set all previous values
		sadiAvp3.setExtensionAvps(sadiAvp2.getExtensionAvps());

		// Verify if values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(sadiAvp3, true);

		// Verify if values have been correctly set
		CxDxAvpAssistant.INSTANCE.testGetters(sadiAvp3);
	...
	public void testAvpFactoryCreateSubscriptionInfo() throws Exception {
		...
		// And set all values using setters
		CxDxAvpAssistant.INSTANCE.testSetters(siAvp2);

		// Create empty...
		SubscriptionInfo siAvp3 = cxdxAvpFactory.createSubscriptionInfo();

		// Verify that no values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(siAvp3, false);

		// Set all previous values
		siAvp3.setExtensionAvps(siAvp2.getExtensionAvps());

		// Verify if values have been set
		CxDxAvpAssistant.INSTANCE.testHassers(siAvp3, true);

		// Verify if values have been correctly set
		CxDxAvpAssistant.INSTANCE.testGetters(siAvp3);
	...
	public void testMessageFactoryApplicationIdChangeRTR() throws Exception {
		...
		BaseFactoriesTest.checkCorrectApplicationIdAVPs(isVendor, isAuth, isAcct, originalRTR);
		...
		BaseFactoriesTest.checkCorrectApplicationIdAVPs(isVendor, isAuth, isAcct, changedRTR);
