...
public class RfFactoriesTest implements DiameterRAInterface {
	...
	public RfFactoriesTest() {
		try {
			...
			// rfClientSession = new RfClientSessionActivityImpl(rfMessageFactory, rfAvpFactory, clientSession, null, null,
			// stack);
	...
	public void testAvpFactoryCreateAddressDomain() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(adAvp2);

		// Create empty...
		AddressDomain adAvp3 = rfAvpFactory.createAddressDomain();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(adAvp3, false);

		// Set all previous values
		adAvp3.setExtensionAvps(adAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(adAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(adAvp3);
	...
	public void testAvpFactoryCreateApplicationServerInformation() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(asiAvp2);

		// Create empty...
		ApplicationServerInformation asiAvp3 = rfAvpFactory.createApplicationServerInformation();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(asiAvp3, false);

		// Set all previous values
		asiAvp3.setExtensionAvps(asiAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(asiAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(asiAvp3);
	...
	public void testAvpFactoryCreateEventType() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(etAvp2);

		// Create empty...
		EventType etAvp3 = rfAvpFactory.createEventType();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(etAvp3, false);

		// Set all previous values
		etAvp3.setExtensionAvps(etAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(etAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(etAvp3);
	...
	public void testAvpFactoryCreateImsInformation() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(iiAvp2);

		// Create empty...
		ImsInformation iiAvp3 = rfAvpFactory.createImsInformation();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(iiAvp3, false);

		// Set all previous values
		iiAvp3.setExtensionAvps(iiAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(iiAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(iiAvp3);
	...
	public void testAvpFactoryCreateInterOperatorIdentifier() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(ioiAvp2);

		// Create empty...
		InterOperatorIdentifier ioiAvp3 = rfAvpFactory.createInterOperatorIdentifier();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(ioiAvp3, false);

		// Set all previous values
		ioiAvp3.setExtensionAvps(ioiAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(ioiAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(ioiAvp3);
	...
	public void testAvpFactoryCreateLcsClientId() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(lcidAvp2);

		// Create empty...
		LcsClientId lcidAvp3 = rfAvpFactory.createLcsClientId();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(lcidAvp3, false);

		// Set all previous values
		lcidAvp3.setExtensionAvps(lcidAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(lcidAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(lcidAvp3);
	...
	public void testAvpFactoryCreateLcsClientName() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(lcnAvp2);

		// Create empty...
		LcsClientName lcnAvp3 = rfAvpFactory.createLcsClientName();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(lcnAvp3, false);

		// Set all previous values
		lcnAvp3.setExtensionAvps(lcnAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(lcnAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(lcnAvp3);
	...
	public void testAvpFactoryCreateLcsInformation() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(liAvp2);

		// Create empty...
		LcsInformation liAvp3 = rfAvpFactory.createLcsInformation();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(liAvp3, false);

		// Set all previous values
		liAvp3.setExtensionAvps(liAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(liAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(liAvp3);
	...
	public void testAvpFactoryCreateLcsRequestorId() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(lriAvp2);

		// Create empty...
		LcsRequestorId lriAvp3 = rfAvpFactory.createLcsRequestorId();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(lriAvp3, false);

		// Set all previous values
		lriAvp3.setExtensionAvps(lriAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(lriAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(lriAvp3);
	...
	public void testAvpFactoryCreateLocationType() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(ltAvp2);

		// Create empty...
		LocationType ltAvp3 = rfAvpFactory.createLocationType();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(ltAvp3, false);

		// Set all previous values
		ltAvp3.setExtensionAvps(ltAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(ltAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(ltAvp3);
	...
	public void testAvpFactoryCreateMbmsInformation() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(miAvp2);

		// Create empty...
		MbmsInformation miAvp3 = rfAvpFactory.createMbmsInformation();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(miAvp3, false);

		// Set all previous values
		miAvp3.setExtensionAvps(miAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(miAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(miAvp3);
	...
	public void testAvpFactoryCreateMessageBody() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(mbAvp2);

		// Create empty...
		MessageBody mbAvp3 = rfAvpFactory.createMessageBody();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(mbAvp3, false);

		// Set all previous values
		mbAvp3.setExtensionAvps(mbAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(mbAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(mbAvp3);
	...
	public void testAvpFactoryCreateMmContentType() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(mmctAvp2);

		// Create empty...
		MmContentType mmctAvp3 = rfAvpFactory.createMmContentType();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(mmctAvp3, false);

		// Set all previous values
		mmctAvp3.setExtensionAvps(mmctAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(mmctAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(mmctAvp3);
	...
	public void testAvpFactoryCreateMmsInformation() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(mmsiAvp2);

		// Create empty...
		MmsInformation mmsiAvp3 = rfAvpFactory.createMmsInformation();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(mmsiAvp3, false);

		// Set all previous values
		mmsiAvp3.setExtensionAvps(mmsiAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(mmsiAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(mmsiAvp3);
	...
	public void testAvpFactoryCreateOriginatorAddress() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(oaAvp2);

		// Create empty...
		OriginatorAddress oaAvp3 = rfAvpFactory.createOriginatorAddress();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(oaAvp3, false);

		// Set all previous values
		oaAvp3.setExtensionAvps(oaAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(oaAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(oaAvp3);
	...
	public void testAvpFactoryCreatePocInformation() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(piAvp2);

		// Create empty...
		PocInformation piAvp3 = rfAvpFactory.createPocInformation();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(piAvp3, false);

		// Set all previous values
		piAvp3.setExtensionAvps(piAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(piAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(piAvp3);
	...
	public void testAvpFactoryCreateTimeStamps() throws Exception {
		...
		// And set all values using setters
		RfAvpAssistant.INSTANCE.testSetters(tsAvp2);

		// Create empty...
		TimeStamps tsAvp3 = rfAvpFactory.createTimeStamps();

		// Verify that no values have been set
		RfAvpAssistant.INSTANCE.testHassers(tsAvp3, false);

		// Set all previous values
		tsAvp3.setExtensionAvps(tsAvp2.getExtensionAvps());

		// Verify if values have been set
		RfAvpAssistant.INSTANCE.testHassers(tsAvp3, true);

		// Verify if values have been correctly set
		RfAvpAssistant.INSTANCE.testGetters(tsAvp3);
