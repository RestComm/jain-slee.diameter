 ...
 * 
 * The Authentication-Information-Answer (AIA) command, indicated by the Command-Code field set to
 * 318 and the 'R' bit cleared in the Command Flags field, is sent from HSS to MME or SGSN. 
 * 
 ...
 */
public interface AuthenticationInformationAnswer extends DiameterMessage {
  ...
  /**
   * Returns true if the Error-Diagnostic AVP is present in the message.
   * 
   * @return true if the Error-Diagnostic AVP is present in the message, false otherwise
   */
  public boolean hasErrorDiagnostic();

  /**
   * Returns the value of the Error-Diagnostic AVP, of type Enumerated.
   * 
   * @return the value of the Error-Diagnostic AVP, of type Enumerated
   */
  public ErrorDiagnostic getErrorDiagnostic();

  /**
   * Sets the value of the Error-Diagnostic AVP, of type Enumerated.
   * 
  ...
  /**
   * Returns true if the Authentication-Info AVP is present in the message.
   * 
   * @return true if the Authentication-Info AVP is present in the message, false otherwise
   */
  public boolean hasAuthenticationInfo();

  /**
   * Returns the value of the Authentication-Info AVP, of type Grouped.
   * Use {@link #hasAuthenticationInfo()} to check the existence of this AVP.
   *   
   * @return the value of the Authentication-Info AVP
   */
