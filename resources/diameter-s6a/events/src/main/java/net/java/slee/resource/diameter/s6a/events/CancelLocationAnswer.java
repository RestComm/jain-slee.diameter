 ...
 * 
 * The Cancel-Location-Answer (CLA) command, indicated by the Command-Code field set to 317 and the
 * 'R' bit cleared in the Command Flags field, is sent from MME or SGSN to HSS.
 * 
 * Message Format
 ...
 */
public interface CancelLocationAnswer extends DiameterMessage {
