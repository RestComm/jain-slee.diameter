 ...
 */
public interface CancelLocationRequest extends DiameterMessage {

    public static final int COMMAND_CODE = 317;
    ...
    /**
     * Returns true if the Cancellation-Type AVP is present in the message.
     *
     * @return
     */
    ...
    /**
     * Returns the value of the Cancellation-Type AVP, of type Grouped.
     *
     * @return
     */
    ...
    /**
     * Sets the value of the Cancellation-Type AVP, of type Grouped.
     *
    ...
    /**
     * Returns true if the CLR-Flags AVP is present in the message
     * @return
     */
    public boolean hasCLRFlags();

    /**
     * Returns the value of the CLR-Flags AVP, of type OctetString.
     * @return
     */
    public long getCLRFlags();

    /**
     * Sets the value of the CLR-Flags AVP, of type OctetString.
     * @param clrFlags
     */
