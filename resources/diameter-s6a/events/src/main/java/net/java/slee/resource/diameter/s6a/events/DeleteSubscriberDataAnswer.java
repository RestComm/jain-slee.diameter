 ...
 */
public interface DeleteSubscriberDataAnswer extends DiameterMessage {
  ...
  /**
   * Returns true if the DSA-Flags AVP is present in the message.
   * 
   * @return
   */
  public boolean hasDSAFlags();

  /**
   * Returns the value of the DSA-Flags AVP, of type Unsigned32.
   * 
   * @return
   */
  ...
  /**
   * Sets the value of the DSA-Flags AVP, of type Unsigned32.
   * 
   * @param dsaFlags
   */
  public void setDSAFlags(long dsaFlags);
