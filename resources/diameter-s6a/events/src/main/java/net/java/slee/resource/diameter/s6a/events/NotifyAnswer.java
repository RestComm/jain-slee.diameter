 ...
 * 
 * The Notify-Answer (NOA) command, indicated by the Command-Code field set to 323 and the 'R' bit
 * cleared in the Command Flags field, is sent from HSS to MME or SGSN.
 * 
 * Message Format
 ...
 */
public interface NotifyAnswer extends DiameterMessage {
