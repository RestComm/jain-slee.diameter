...
/**
 * Defines an interface representing the Notify-Request message.
 ...
 *                       [ NOR-Flags ]
 *                       [ Homogeneous-Support-of-IMS-Voice-Over-PS-Sessions ] //R12
 *                      *[ AVP ]
 *                      *[ Proxy-Info ]
 *                      *[ Route-Record ]
 * </pre>
...
public interface NotifyRequest extends DiameterMessage {
   ...
   */
    ...
    /**
     * Returns the UE-SRVCC-Capability AVP object, of type Enumerated
     *
     * @return
     */
    ...
    /**
     * Sets the UE-SRVCC-Capability AVP object in the message, of type Enumerated.
     *
     * @param uesrvccCapability
     */
    public void setUESRVCCCapability(UESRVCCCapability uesrvccCapability);

    /**
     * Returns true if Homogeneous-Support-Of-IMS-Voice-Over-PS-Sessions AVP is present in the message.
     *
     * @return
     */
    ...
    /**
     * Returns the Homogeneous-Support-Of-IMS-Voice-Over-PS-Sessions AVP object, of type Enumerated
     *
     * @return
     */
    ...
    /**
     * Sets the Homogeneous-Support-Of-IMS-Voice-Over-PS-Sessions AVP object in the message, of type Enumerated.
     *
