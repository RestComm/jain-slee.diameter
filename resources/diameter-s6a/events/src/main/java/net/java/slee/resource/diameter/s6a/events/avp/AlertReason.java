 ...
 */
public class AlertReason implements Enumerated, Serializable {
  ...
  public static final AlertReason UE_PRESENT = new AlertReason(_UE_PRESENT);
  public static final AlertReason UE_MEMORY_AVAILABLE = new AlertReason(_UE_MEMORY_AVAILABLE);
  ...
  public static AlertReason fromInt(int type) {
    switch (type) {
      case _UE_PRESENT:
        return UE_PRESENT;
