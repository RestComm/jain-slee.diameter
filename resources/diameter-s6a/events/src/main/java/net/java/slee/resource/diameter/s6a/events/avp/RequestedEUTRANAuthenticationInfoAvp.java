...
/**
 * Defines an interface representing the Requested-EUTRAN-Authentication-Info grouped AVP type.
 * From the Diameter S6a Reference Point Protocol Details (3GPP TS 29.272 V12.8.0) specification:
 * 
 * <pre>
 * 7.3.11  Requested-EUTRAN-Authentication-Info
 * 
 * The Requested-EUTRAN-Authentication-Info is of type Grouped. It shall contain the information
 * related to the authentication requests for E-UTRAN.
 * 
 * AVP format
 * Requested-UTRAN-GERAN-Authentication-Info ::= < AVP header: 1408 10415 >
 ...
 */
public interface RequestedEUTRANAuthenticationInfoAvp extends GroupedAvp {
