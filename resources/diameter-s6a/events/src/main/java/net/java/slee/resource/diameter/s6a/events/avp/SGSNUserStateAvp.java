...
/**
 * Defines an interface representing the SGSN-User-State grouped AVP type.
 * From the Diameter S6a Reference Point Protocol Details (3GPP TS 29.272 V12.8.0) specification:
 * 
 * <pre>
 * 7.3.113  SGSN-User-State
 * 
 * The SGSN-User-State AVP is of type Grouped. It shall contain the information related to the user
 * state in the SGSN.
 * 
 * AVP format
 ...
 */
public interface SGSNUserStateAvp extends GroupedAvp {
