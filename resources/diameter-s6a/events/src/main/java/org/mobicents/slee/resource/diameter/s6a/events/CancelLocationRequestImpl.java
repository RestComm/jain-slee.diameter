...
public class CancelLocationRequestImpl extends DiameterMessageImpl implements CancelLocationRequest {
    ...
    /* (non-Javadoc)
     * @see net.java.slee.resource.diameter.s6a.events.CancelLocationRequest#hasCLRFlags()
     */
    public boolean hasCLRFlags() {
        return hasAvp(DiameterS6aAvpCodes.CLR_FLAGS, DiameterS6aAvpCodes.S6A_VENDOR_ID);
    }

    /* (non-Javadoc)
     * @see net.java.slee.resource.diameter.s6a.events.CancelLocationRequest#getCLRFlags()
     */
    public long getCLRFlags() {
        return getAvpAsUnsigned32(DiameterS6aAvpCodes.CLR_FLAGS, DiameterS6aAvpCodes.S6A_VENDOR_ID);
    }

    /* (non-Javadoc)
     * @see net.java.slee.resource.diameter.s6a.events.CancelLocationRequest#setCLRFlags(long)
     */
    public void setCLRFlags(long clrFlags) {
        addAvp(DiameterS6aAvpCodes.CLR_FLAGS, DiameterS6aAvpCodes.S6A_VENDOR_ID, clrFlags);
    }
}