...
public class InsertSubscriberDataAnswerImpl extends DiameterMessageImpl implements InsertSubscriberDataAnswer {
    ...
    /* (non-Javadoc)
     * @see net.java.slee.resource.diameter.s6a.events.InsertSubscriberDataAnswer#hasLocalTimeZone()
     */
    public boolean hasLocalTimeZone() {
        return hasAvp(DiameterS6aAvpCodes.LOCAL_TIME_ZONE, DiameterS6aAvpCodes.S6A_VENDOR_ID);
    }

    /* (non-Javadoc)
     * @see net.java.slee.resource.diameter.s6a.events.InsertSubscriberDataAnswer#getLocalTimeZone()
     */
    public LocalTimeZoneAvp getLocalTimeZone() {
        return (LocalTimeZoneAvp) getAvpAsCustom(DiameterS6aAvpCodes.LOCAL_TIME_ZONE, DiameterS6aAvpCodes.S6A_VENDOR_ID,
                LocalTimeZoneAvpImpl.class);
    }

    /* (non-Javadoc)
     * @see net.java.slee.resource.diameter.s6a.events.InsertSubscriberDataAnswer#setLocalTimeZone(net.java.slee.resource.diameter.s6a.events.avp.LocalTimeZoneAvp)
     */
    public void setLocalTimeZone(LocalTimeZoneAvp localTimeZoneAvp) {
        addAvp(DiameterS6aAvpCodes.LOCAL_TIME_ZONE, DiameterS6aAvpCodes.S6A_VENDOR_ID, localTimeZoneAvp.byteArrayValue());
    }
}