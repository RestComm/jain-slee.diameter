...
/**
 * Implementation for {@link net.java.slee.resource.diameter.s6a.events.avp.CSGSubscriptionDataAvp}
 *
 ...
 */
public class CSGSubscriptionDataAvpImpl extends GroupedAvpImpl implements CSGSubscriptionDataAvp {

    public CSGSubscriptionDataAvpImpl() {
        super();
    }

    public CSGSubscriptionDataAvpImpl(int code, long vendorId, int mnd, int prt, byte[] value) {
