...
/**
 * Implementation for {@link net.java.slee.resource.diameter.s6a.events.avp.CallBarringInfoAvp}
 *
 ...
 */
public class CallBarringInfoAvpImpl extends GroupedAvpImpl implements CallBarringInfoAvp {

    public CallBarringInfoAvpImpl() {
        super();
    }

    public CallBarringInfoAvpImpl(int code, long vendorId, int mnd, int prt, byte[] value) {
