...
public interface SubscribeNotificationsAnswer extends DiameterShMessage {
  ...
  /**
   * Returns the value of the User-Data AVP, of type OctetString. Use
   * {@link #hasUserData()} to check the existence of this AVP.
   * 
   * @return the value of the User-Data AVP
   * @throws IllegalStateException
   *             if the User-Data AVP has not been set on this message
   */
  byte[] getUserData();
