...
public class ShServerFactoriesTest implements DiameterRAInterface {
	...
	static {
		...
		serverSubsSession = new ShServerSubscriptionActivityImpl(shServerFactory, shAvpFactory, stackServerSession, new DiameterIdentity("127.0.0.1"), new DiameterIdentity(
				"mobicents.org"));
		serverSubsSession.setSessionListener(new ShServerFactoriesTest());

		// ShClientSessionImpl stackClientSession = (ShClientSessionImpl) sf.getNewSession("321", ClientShSession.class,
		// shAppId, new Object[0]);
