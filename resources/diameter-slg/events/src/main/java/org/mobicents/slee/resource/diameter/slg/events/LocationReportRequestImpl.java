...
public class LocationReportRequestImpl extends DiameterMessageImpl implements LocationReportRequest {
  ...
  public boolean hasLocationEvent() {
    return hasAvp(EPCLocationProtocolAVPCodes.LOCATION_EVENT);
  }
  ...
  public LocationEvent getLocationEvent() {
    return (LocationEvent) getAvpAsEnumerated(EPCLocationProtocolAVPCodes.LOCATION_EVENT, LocationEvent.class);
  }
  ...
  public void setLocationEvent(LocationEvent locationEvent) throws IllegalStateException {
    addAvp(EPCLocationProtocolAVPCodes.LOCATION_EVENT, locationEvent.getValue());
  }
  ...
  public boolean hasPseudonymIndicator() {
    return hasAvp(EPCLocationProtocolAVPCodes.PSEUDONYM_INDICATOR);
  }
  ...
  public PseudonymIndicator getPseudonymIndicator() {
    return (PseudonymIndicator) getAvpAsEnumerated(EPCLocationProtocolAVPCodes.PSEUDONYM_INDICATOR, PseudonymIndicator.class);
  }
  ...
  public void setPseudonymIndicator(PseudonymIndicator pseudonymIndicator) throws IllegalStateException {
    addAvp(EPCLocationProtocolAVPCodes.PSEUDONYM_INDICATOR, pseudonymIndicator);
  }
  ...
  public boolean hasLRRFlags() {
    return hasAvp(EPCLocationProtocolAVPCodes.LRR_FLAGS);
  }
  ...
  public void setLRRFlags(long lrrFlags) throws IllegalStateException {
    addAvp(EPCLocationProtocolAVPCodes.LRR_FLAGS, lrrFlags);
  }
  ...
  public boolean hasDeferredMTLRData() {
    return hasAvp(EPCLocationProtocolAVPCodes.DEFERRED_MT_LR_DATA);
  }
  ...
  public void setDeferredMTLRData(DeferredMTLRDataAvp deferredMTLRDataAvp) throws IllegalStateException {
    addAvp(EPCLocationProtocolAVPCodes.DEFERRED_MT_LR_DATA, deferredMTLRDataAvp);
  }
  ...
  public void setDeferredLocationType(long deferredLocationType) throws IllegalStateException {
    addAvp(EPCLocationProtocolAVPCodes.DEFERRED_LOCATION_TYPE, deferredLocationType);
  }
  ...
  public boolean hasTerminationCause() {
    return hasAvp(EPCLocationProtocolAVPCodes.TERMINATION_CAUSE);
  }
  ...
  public void setTerminationCause(long terminationCause) throws IllegalStateException {
    addAvp(EPCLocationProtocolAVPCodes.TERMINATION_CAUSE, terminationCause);
  }
  ...
  public boolean hasReportingAmount() {
    return hasAvp(EPCLocationProtocolAVPCodes.REPORTING_AMOUNT);
  }
  ...
  public void setReportingAmount(long reportingAmount) throws IllegalStateException {
    addAvp(EPCLocationProtocolAVPCodes.REPORTING_AMOUNT, reportingAmount);
  }
  ...
  public boolean hasPeriodicLDRInformation() {
    return hasAvp(EPCLocationProtocolAVPCodes.PERIODIC_LDR_INFORMATION);
  }
  ...
  public void setPeriodicLDRInformation(PeriodicLDRInfoAvp periodicLDRInfoAvp) throws IllegalStateException {
    addAvp(EPCLocationProtocolAVPCodes.PERIODIC_LDR_INFORMATION, periodicLDRInfoAvp);
  }
  ...
  public boolean hasReportingInterval() {
    return hasAvp(EPCLocationProtocolAVPCodes.REPORTING_INTERVAL);
  }
  ...
  public void setReportingInterval(long reportingInterval) throws IllegalStateException {
    addAvp(EPCLocationProtocolAVPCodes.REPORTING_INTERVAL, reportingInterval);
  }
  ...
  public boolean has1xRTTRCID() {
    return hasAvp(EPCLocationProtocolAVPCodes.ONExRTT_RCID);
  }
  ...
  public void set1xRTTRCID(byte[] onexRTTRCID) throws IllegalStateException {
    addAvp(EPCLocationProtocolAVPCodes.ONExRTT_RCID, onexRTTRCID);
  }
  ...
  public boolean hasDelayedLocationReportingData() {
    return hasAvp(EPCLocationProtocolAVPCodes.DELAYED_LOCATION_REPORTING_DATA);
  }
  ...
  public void setDelayedLocationReportingData(DelayedLocationReportingDataAvp delayedLocationReportingData) throws IllegalStateException {
    addAvp(EPCLocationProtocolAVPCodes.DELAYED_LOCATION_REPORTING_DATA, delayedLocationReportingData);
  }
