...
public class AdditionalAreaAvpImpl extends GroupedAvpImpl implements AdditionalAreaAvp {
  ...
  public void setAreaType(long additionalAreaType) {
    addAvp(ELPAVPCodes.AREA_TYPE, ELPAVPCodes.SLg_VENDOR_ID, additionalAreaType);
  }
  ...
  public void setAreaIdentification(byte[] additionalAreaIdentification) {
