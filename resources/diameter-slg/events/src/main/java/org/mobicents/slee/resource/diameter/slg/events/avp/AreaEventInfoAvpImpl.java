...
/**
 * Implementation for {@link AreaEventInfoAvp}
 *
...
public class AreaEventInfoAvpImpl extends GroupedAvpImpl implements AreaEventInfoAvp {
  ...
  public boolean hasAreaDefinition() {
    return hasAvp(ELPAVPCodes.AREA_DEFINITION, ELPAVPCodes.SLg_VENDOR_ID);
  }

  public AreaDefinitionAvp getAreaDefinition() {
    return (AreaDefinitionAvp) getAvpAsCustom(ELPAVPCodes.AREA_DEFINITION, ELPAVPCodes.SLg_VENDOR_ID, AreaDefinitionAvpImpl.class);
  }

  public void setAreaDefinition(AreaDefinitionAvp areaDefinition){
    addAvp(ELPAVPCodes.AREA_DEFINITION, ELPAVPCodes.SLg_VENDOR_ID, areaDefinition.byteArrayValue());
  }
