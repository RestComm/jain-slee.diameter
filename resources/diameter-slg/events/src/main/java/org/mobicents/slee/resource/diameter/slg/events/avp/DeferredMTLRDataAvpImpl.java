...
/**
 * Implementation for {@link DeferredMTLRDataAvp}
 *
...
public class DeferredMTLRDataAvpImpl extends GroupedAvpImpl implements DeferredMTLRDataAvp {
  ...
  public void setDeferredLocationType(long deferredLocationType) {
    addAvp(ELPAVPCodes.DEFERRED_LOCATION_TYPE, ELPAVPCodes.SLg_VENDOR_ID, deferredLocationType);
  }
  ...
  public long getTerminationCause() {
    return getAvpAsUnsigned32(ELPAVPCodes.TERMINATION_CAUSE, ELPAVPCodes.SLg_VENDOR_ID);
  }
