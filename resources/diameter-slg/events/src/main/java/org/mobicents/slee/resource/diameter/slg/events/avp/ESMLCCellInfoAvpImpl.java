...
/**
 * Implementation for {@link ESMLCCellInfoAvp}
 *
...
public class ESMLCCellInfoAvpImpl extends GroupedAvpImpl implements ESMLCCellInfoAvp {
  ...
  public boolean hasCellPortionID() {
    return hasAvp(ELPAVPCodes.CELL_PORTION_ID, ELPAVPCodes.SLg_VENDOR_ID);
  }

  public long getCellPortionID() {
    return getAvpAsUnsigned32(ELPAVPCodes.CELL_PORTION_ID, ELPAVPCodes.SLg_VENDOR_ID);
  }

  public void setCellPortionID(long cellPortionId) {
    addAvp(ELPAVPCodes.CELL_PORTION_ID, ELPAVPCodes.SLg_VENDOR_ID, cellPortionId);
  }
