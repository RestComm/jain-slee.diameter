...
/**
 * Implementation for {@link net.java.slee.resource.diameter.slg.events.avp.LCSPrivacyCheckSessionAvp}
 *
...
public class LCSPrivacyCheckSessionAvpImpl extends GroupedAvpImpl implements LCSPrivacyCheckSessionAvp {
  ...
  public boolean hasLCSPrivacyCheck() {
    return hasAvp(EPCLocationProtocolAVPCodes.LCS_PRIVACY_CHECK_SESSION, EPCLocationProtocolAVPCodes.LCS_PRIVACY_CHECK);
  }

  public int getLCSPrivacyCheck() {
    return getAvpAsInteger32(EPCLocationProtocolAVPCodes.LCS_PRIVACY_CHECK_SESSION, EPCLocationProtocolAVPCodes.LCS_PRIVACY_CHECK);
  }

  public void setLCSPrivacyCheck(int lcsPrivacyCheck) {
    addAvp(EPCLocationProtocolAVPCodes.LCS_PRIVACY_CHECK_SESSION, EPCLocationProtocolAVPCodes.LCS_PRIVACY_CHECK);
  }
