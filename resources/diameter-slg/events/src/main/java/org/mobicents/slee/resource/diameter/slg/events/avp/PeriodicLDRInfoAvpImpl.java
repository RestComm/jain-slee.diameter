...
public class PeriodicLDRInfoAvpImpl extends GroupedAvpImpl implements PeriodicLDRInfoAvp {
  ...
  public boolean hasReportingInterval() {
    return hasAvp(ELPAVPCodes.REPORTING_INTERVAL, ELPAVPCodes.SLg_VENDOR_ID);
  }

  public long getReportingInterval() {
    return getAvpAsUnsigned32(ELPAVPCodes.REPORTING_INTERVAL, ELPAVPCodes.SLg_VENDOR_ID);
  }

  public void setReportingInterval(long reportingInterval) {
    addAvp(ELPAVPCodes.REPORTING_INTERVAL, ELPAVPCodes.SLg_VENDOR_ID, reportingInterval);
  }
