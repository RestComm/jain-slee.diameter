...
//    eventsTemp.put(ProvideLocationRequest.COMMAND_CODE, SLg_PACKAGE_PREFIX + "Immediate Location Information");
//    eventsTemp.put(LocationReportRequest.COMMAND_CODE, SLg_PACKAGE_PREFIX + "Deferred Location Information Report");
