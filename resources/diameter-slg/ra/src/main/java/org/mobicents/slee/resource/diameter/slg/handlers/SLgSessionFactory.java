...
/*
  ...
  public void stateChanged(AppSession source, Enum oldState, Enum newState) {
    //slgResourceAdaptor.stateChanged(source, oldState, newState);
...
/*
  @Override
  public void doProvideLocationRequest(ClientSLgSession session, ProvideLocationRequest request) throws InternalException, IllegalDiameterStateException, RouteException, OverloadException  {
    logger.info("Diameter SLg Session Factory :: doProvideLocationRequest :: appSession[" + appSession + "], Request[" + request + "]");
    dofireEvent(appSession, request.getMessage());
  }

  @Override
  public void doProvideLocationAnswer(ClientSLgSession session, ProvideLocationRequest request, ProvideLocationAnswer answer) throws InternalException {
    logger.info("Diameter SLg Session Factory :: doProvideLocationAnswer :: appSession[" + appSession + "], Request[" + request + "], Answer[" + answer + "]");
    doFireEvent(appSession, answer.getMessage());
  }

  @Override
  public void doLocationReportRequest(ServerSLgSession session, LocationReportRequest request) throws InternalException, IllegalDiameterStateException, RouteException, OverloadException {
    logger.info("Diameter SLg Session Factory :: doLocationReportRequest :: appSession[" + appSession + "], Request[" + request + "]");
    dofireEvent(appSession, request.getMessage());
  }

  @Override
  public void doLocationReportAnswer(ClientSLgSession session, LocationReportRequest request, LocationReportAnswer answer) throws InternalException {
    logger.info("Diameter SLg Session Factory :: doLocationReportAnswer :: appSession[" + appSession + "], Request[" + request + "], Answer[" + answer + "]");
    doFireEvent(appSession, answer.getMessage());
  }
*/
}