...
public interface SLgServerSessionActivity extends SLgSessionActivity {
  ...
  ProvideLocationAnswer createProvideLocationAnswer();

  void sendProvideLocationAnswer(ProvideLocationAnswer pla) throws IOException;

  LocationReportRequest createLocationReportRequest();

  void sendLocationReportRequest(LocationReportRequest lrr) throws IOException;
