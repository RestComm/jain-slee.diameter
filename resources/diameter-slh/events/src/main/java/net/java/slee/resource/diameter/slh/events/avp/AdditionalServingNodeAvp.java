...
/**
 * Defines an interface representing the Additional-Serving-Node grouped AVP type.
...
public interface AdditionalServingNodeAvp extends GroupedAvp {
  ...
  */
  ...
  void setSGSNNumber(byte[] additionalSgsnNumber);
  ...
  */
  ...
  void setSGSNName(DiameterIdentity additionalSgsnName);
  ...
  */
  ...
  void setSGSNRealm(DiameterIdentity additionalSgsnRealm);
  ...
  */
  ...
  void setMMEName(DiameterIdentity additionalMmeName);
  ...
  */
  ...
  void setMMERealm(DiameterIdentity additionalMmeRealm);
  ...
  */
  ...
  void setMSCNumber(byte[] additionalMscNumber);
  ...
  */
  ...
  void set3GPPAAAServerName(DiameterIdentity additional3gppAAAServerName);
  ...
  */
  ...
  void setGMLCAddress(Address additionalGmlcAddress);
