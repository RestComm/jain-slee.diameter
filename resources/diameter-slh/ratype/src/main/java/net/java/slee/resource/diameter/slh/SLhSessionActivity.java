...
/**
 * SLhSessionActivity.java
 *
 * @author <a href="mailto:fernando.mendioroz@gmail.com"> Fernando Mendioroz </a>
 * @author <a href="mailto:brainslog@gmail.com"> Alexandre Mendonca </a>
 * @author <a href="mailto:baranowb@gmail.com"> Bartosz Baranowski </a>
 */
public interface SLhSessionActivity extends DiameterActivity {

  /**
   * Provides session state information.
   *
   * @return instance of {@link SLhSessionState}
   */
  ...
  /**
   * Returns the session ID of the SLh session, which uniquely
